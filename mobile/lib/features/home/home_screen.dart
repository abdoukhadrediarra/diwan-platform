      ...
      body: RefreshIndicator(
        ...
        child: ListView(
          ...
          children: [
            ...
            const _SectionTitle('Le corpus en chiffres'),
            _Figures(live: _live),
            const SizedBox(height: 36),
            const _SectionTitle('Le Cheikh'),
            ..._biography.map((p) => _Paragraph(p)),
            const SizedBox(height: 12),
            const _Timeline(),
            const SizedBox(height: 36),
            const _SectionTitle('Le projet'),
            const _Paragraph(
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        const ArabicText('الشيخ أحمد بمب', size: 46, weight: FontWeight.w700, color: DiwanColors.emerald, height: 1.4),
        const Text(
        ...
        const ArabicText('خَادِمُ الرَّسُولِ', size: 22, color: DiwanColors.gold, height: 1.6),
